...
import { HERO_VIDEO_PLAYBACK_ID, HERO_VIDEO_POSTER_SRC } from "../lib/video-urls";
  ...
  return (
    ...
    >
      <Image
        ...
        sizes="100vw"
        aria-hidden="true"
        className="absolute inset-0 -z-20 h-full w-full object-cover brightness-110 contrast-110"
      />
      ...
      <MuxBgVideo
        ...
        maxResolution="2160p"
        preload="auto"
        className="absolute inset-0 -z-10 brightness-110 contrast-110"
      />

      <div
        aria-hidden
        className="absolute inset-0 -z-10 bg-linear-to-b from-black/30 via-black/40 to-black/60"
      />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center sm:px-8">
        ...
        <ScrollReveal delay={120}>
          <h1 className="mt-6 max-w-4xl text-balance text-4xl leading-tight tracking-[-0.5px] text-white sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <span className="bg-linear-to-r from-rose to-blue bg-clip-text text-transparent">
              Drone
            </span>{" "}
            em São Paulo
          </h1>
        ...
        <ScrollReveal delay={220}>
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row">
            <a
              ...
              className="group inline-flex h-14 items-center justify-center gap-3 rounded-full bg-linear-to-r from-blue to-rose px-8 text-base font-medium text-white shadow-[0_12px_40px_-12px_rgba(92,140,255,0.55)] transition-all duration-300 ease-out hover:scale-[1.02]"
            >
